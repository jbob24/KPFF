<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditableEngineerProjectList.ascx.cs" Inherits="KPFF.Web.UserControls.EditableEngineerProjectList" %>

<%@ Register Src="HourBox.ascx" TagName="HourBox" TagPrefix="hb" %>
<asp:GridView ID="gridHours" runat="server" AutoGenerateColumns="false" CssClass="hoursGrid tablesorter scrollTable"
    ShowFooter="true" OnPreRender="gridHours_PreRender" DataKeyNames="ID, ProjectID"
    ...
    <Columns>
        ...
        <asp:BoundField FooterStyle-CssClass="footerStyle" DataField="ProjectNo" HeaderText="Job #"
            HeaderStyle-CssClass="{sorter: false}" />
        <asp:TemplateField>
            <HeaderTemplate>
