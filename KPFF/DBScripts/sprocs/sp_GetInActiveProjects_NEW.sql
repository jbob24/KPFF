IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetInActiveProjects_NEW]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_GetInActiveProjects_NEW]
GO
...
CREATE PROCEDURE [dbo].[sp_GetInActiveProjects_NEW]
	@EmployeeID int
