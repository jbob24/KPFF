<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/MyAdmin/ClientEdit.apsx.cs" Inherits="KPFF.PMP.MyAdmin.ClientEdit" %>
    ...
    <table cellpadding="2" cellspacing="0" border="0" width="410" style="border-left: solid 1px #666699;
        ...
        <tr>
            <td colspan="2" bgcolor="#000066" valign="middle">
                &nbsp; <font style="color: #ffffff; font-size: 12px;"><b>Edit Client Information</b></font>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnUpdate" runat="server" CssClass="formButton" Text="Update Client" OnClick="btnUpdate_Click" /><img
