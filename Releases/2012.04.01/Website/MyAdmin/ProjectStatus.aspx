<%@ Page Language="C#" MasterPageFile="~/MyAdmin/_TemplateMaster.master" AutoEventWireup="true" CodeBehind="~/MyAdmin/ProjectStatus.apsx.cs" Inherits="KPFF.PMP.MyAdmin.ProjectStatus" title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" Runat="Server">
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td>
                <b>>> Project Status</b><img src="images/spacer.gif" height="1" width="48" /><asp:Button CssClass="formButton" ID="btnUpdate" runat="server" Text="Update Grid" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <igtbl:UltraWebGrid ID="uwgProjectStatus" runat="server" DataKeyField="ID" DataMember="ProjectStatus" OnInitializeLayout="uwgPhases_DeleteRowBatch" OnUpdateGrid="uwgPhases_UpdateGrid" OnDeleteRowBatch="uwgPhases_DeleteRowBatch">
                    <Bands>
