<%@ Page Language="C#" MasterPageFile="~/MyAdmin/_TemplateMaster.master" AutoEventWireup="true" CodeBehind="~/MyAdmin/Phases.apsx.cs" Inherits="KPFF.PMP.MyAdmin.Phases" title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" Runat="Server">
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td>
                <b>>> Phases</b><img src="images/spacer.gif" height="1" width="98" /><asp:Button CssClass="formButtonUpdate" ID="btnUpdate" runat="server" Text="Update Grid" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <igtbl:UltraWebGrid ID="uwgPhases" runat="server" DataKeyField="ID" DataMember="Phases" OnDeleteRowBatch="uwgPhases_DeleteRowBatch" OnInitializeLayout="uwgPhases_InitializeLayout" OnUpdateGrid="uwgPhases_UpdateGrid">
                    <Bands>
