/****** Object:  StoredProcedure [dbo].[sp_GetProjectListByEmployeeID]    Script Date: 10/23/2012 21:07:02 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_GetProjectListByEmployeeID]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[sp_GetProjectListByEmployeeID]
GO
...
CREATE PROCEDURE [dbo].[sp_GetProjectListByEmployeeID]
	@EmployeeID int,
	@StartDate datetime,
	@EndDate datetime,
