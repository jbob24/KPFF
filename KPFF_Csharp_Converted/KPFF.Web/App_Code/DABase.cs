...
namespace KPFF.PMP
{
    ...
    //    protected SqlDataReader GetDataReaderByStoredProcedure(string procedureName, Dictionary<string, string> @params, SqlConnection con)
    //    {
    ...
    //    private void AddParamaters(SqlCommand cmd, Dictionary<string, string> @params)
    //    {
