<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/MyAccount/ProjectDetail.aspx.cs" Inherits="KPFF.PMP.MyAccount.ProjectDetail" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.hoursGrid').hourbox2({
                editable: true,
                sortable: true,
                sortType: ['integer', 'link', 'string', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox', 'hourbox'],
                colresizable: true,
...
<%--    <script type="text/javascript" src="../HoursBox/HourBox.js"></script>--%>
    ...
    <%--    <script type="text/javascript">
        $(document).ready(function () { $(document).focus( function () { location.reload(); }); });   
    </script>--%>
</head>
<body>
