...
{
    public partial class DisplayGroup : System.Web.UI.Page
    {
        #region Properties
        ...
        private void BindData()
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                weekCal.Text = WeekDate.WYFirst.MondayDate;
            }
        }
        ...
        private void AddEngineerDetail(int empId)
        {
            ...
            EngineerDetail detail = (EngineerDetail)LoadControl("~/UserControls/EngineerDetail.ascx");
