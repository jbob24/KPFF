<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/MyAccount/EmployeeDetail.aspx.cs" Inherits="KPFF.PMP.MyAccount.EmployeeDetail" Title="Employee Detail" %>
...
<body>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td align="right">
                    ...
                    &nbsp;
                    <asp:Button CssClass="formButton" ID="btnAddProject" runat="server" onclick="btnAddProject_Click" Text="Assign" />
                </td>
            </tr>
        </table>
    </div>
    <%--    <div class="ProjectsAdd" id="ProjectsAdd">
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td class="detailTitle">
                    <asp:RadioButton ID="rbByName" class="rbByName" runat="server" Text="Order By Name" Checked="true" GroupName="projectsGroup" />
                    <asp:RadioButton ID="rbByNumber" class="rbByNumber" runat="server" Text="Order By Number" GroupName="projectsGroup" />
                </td>
            </tr>
            <tr>
                <td class="detailTitle">
                    <div id="projectsByName">
                        <asp:DropDownList ID="cboProjectsByName" CssClass="forms" runat="server">
                        </asp:DropDownList>
                    </div>
                    <div id="projectsByNumber" style="display:none">
                        <asp:DropDownList ID="cboProjectsByNumber" CssClass="forms" runat="server">
                        </asp:DropDownList>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td align="right">
                    <input type="button" value="Close" class="formButton" id="btnCloseAddProject" />
                    &nbsp;
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td align="left">
                ...
                <input type="button" class="formButton" value="Print" onclick="javascript: window.open('EmployeeDetail_Print.aspx?EID=<%Response.Write(Request.Params["EID"]); %>','EmployeeDetailPrint','toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, width=700, height=500, top=5, left=5');" />
