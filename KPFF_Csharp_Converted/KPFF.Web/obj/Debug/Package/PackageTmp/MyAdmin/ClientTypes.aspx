<%@ Page Language="C#" MasterPageFile="~/MyAdmin/_TemplateMaster.master" AutoEventWireup="true" CodeBehind="~/MyAdmin/ClientTypes.apsx.cs" Inherits="KPFF.PMP.MyAdmin.ClientTypes" title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" Runat="Server">
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td>
                <b>>> Client Types</b><img src="images/spacer.gif" width="100" height="1" /><asp:Button CssClass="formButtonUpdate" ID="btnUpdate" runat="server" Text="Update Grid" />
            </td>          
        </tr>
        <tr>
        ...
        <tr>
            <td valign="top">
                <igtbl:UltraWebGrid ID="uwgClientTypes" runat="server" DataKeyField="ID" DataMember="ClientType" OnDeleteRowBatch="uwgPhases_DeleteRowBatch" OnInitializeLayout="uwgPhases_InitializeLayout" OnUpdateGrid="uwgPhases_UpdateGrid">
                    <Bands>
                    ...
                    <DisplayLayout AllowAddNewDefault="Yes" AllowColSizingDefault="Free" AllowDeleteDefault="Yes"
                        ...
                        Name="uwgClientTypes" RowHeightDefault="15px" SelectTypeRowDefault="Extended"
                        Version="4.00">
