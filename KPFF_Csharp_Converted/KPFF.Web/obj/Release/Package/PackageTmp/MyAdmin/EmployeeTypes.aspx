<%@ Page Language="C#" MasterPageFile="~/MyAdmin/_TemplateMaster.master" AutoEventWireup="true" CodeBehind="~/MyAdmin/EmployeeTypes.apsx.cs" Inherits="KPFF.PMP.MyAdmin.EmployeeTypes" title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" Runat="Server">
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td>
                <b>>> Employee Types</b><img src="images/spacer.gif" height="1" width="28" /><asp:Button CssClass="formButtonUpdate" ID="btnUpdate" runat="server" Text="Update Grid" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <igtbl:UltraWebGrid ID="uwgEmployeeTypes" runat="server" DataKeyField="ID" DataMember="EmployeeType"  OnDeleteRowBatch="uwgPhases_DeleteRowBatch" OnInitializeLayout="uwgPhases_InitializeLayout" OnUpdateGrid="uwgPhases_UpdateGrid">
                    <Bands>
