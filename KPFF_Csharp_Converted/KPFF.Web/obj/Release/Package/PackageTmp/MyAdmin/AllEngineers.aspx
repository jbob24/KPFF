<%@ Page Language="C#" MasterPageFile="~/MyAdmin/_TemplateMasterNoSub.master" AutoEventWireup="true"
    CodeBehind="~/MyAdmin/AllEngineers.aspx.cs" Inherits="KPFF.PMP.MyAdmin.AllEngineers" Title="Untitled Page" %>
    ...
    <div class="EmployeesFilter" id="EmployeesFilter">
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td width="90">
                    <igsch:WebDateChooser ID="FilterStart" runat="server" Width="90px" AllowNull="False">
