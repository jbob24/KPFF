<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/MyAdmin/EmployeeEdit.apsx.cs" Inherits="KPFF.PMP.MyAdmin.EmployeeEdit" %>
        ...
        <table cellpadding="2" cellspacing="0" border="0" width="410" style="border-left: solid 1px #666699;
            ...
            <tr>
                <td colspan="2" bgcolor="#000066" valign="middle">
                    &nbsp; <font style="color: #ffffff; font-size: 12px;"><b>Edit Employee Information</b></font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPhoneExtension" runat="server" Width="250px" MaxLength="50" CssClass="forms ValidateInt"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="formContent">
                ...
                <td>
                    <asp:TextBox ID="txtEmail" runat="server" Width="250px" MaxLength="50" CssClass="forms"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="formContent">
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBox ID="pmFiscalSummary" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="formContent">
                ...
                <td>
                    <asp:CheckBox ID="picFiscalSummary" runat="server" />
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" align="right">
                    ...
                    <asp:Button ID="btnUpdate" runat="server" Text="Update Employee" CssClass="formButton" OnClick="btnUpdate_Click" /><img
