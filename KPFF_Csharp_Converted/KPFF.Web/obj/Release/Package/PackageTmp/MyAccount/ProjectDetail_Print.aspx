<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/MyAccount/ProjectDetail_Print.aspx.cs" Inherits="KPFF.PMP.MyAccount.ProjectDetail_Print" %>
            ...
            <tr>
                <td>
                    <igtbl:UltraWebGrid ID="uwgProjects" runat="server" Width="800px" OnSortColumn="uwgProjects_SortColumn">
                        ...
                        <DisplayLayout
                            HeaderClickActionDefault="SortSingle" name="uwgProjects" RowHeightDefault="20px" SelectTypeRowDefault="Single" Version="4.00" StationaryMargins="Header" IndentationTypeDefault="Flat" TableLayout="Fixed" AllowSortingDefault="Yes">
