<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/MyAccount/ProjectDetailAdd.aspx.cs" Inherits="KPFF.PMP.MyAccount.ProjectDetailAdd" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add Project Summary</title>
        ...
        <table cellpadding="2" cellspacing="0" border="0" width="746" style="border-left: solid 1px #666699;
            ...
            <tr>
                <td colspan="4" bgcolor="#000066" valign="middle">
                    &nbsp; <font style="color: #ffffff; font-size: 12px;"><b>Add Project</b></font>
            </tr>
            <tr>
                ...
                <td width="230" class="detailData">
                    <asp:TextBox ID="txtProjectNo" runat="server" CssClass="forms" MaxLength="50" Width="220px"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4" align="right">
                    &nbsp;<input class="formButton" onclick="javascript:window.close();" type="button"
                        value="Close Window" />&nbsp;
                    <asp:Button ID="btnAdd" runat="server" CssClass="formButton" Text="Add Project" OnClick="btnAdd_Click" /><img
