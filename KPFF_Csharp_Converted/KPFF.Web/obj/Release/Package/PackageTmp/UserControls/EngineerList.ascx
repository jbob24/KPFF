<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EngineerList.ascx.cs"
    Inherits="KPFF.PMP.UserControls.EngineerList" %>
...
<asp:GridView ID="gridHours" runat="server" AutoGenerateColumns="false" CssClass="hoursGrid tablesorter scrollTable" OnPreRender="gridHours_PreRender"
    ...
    <Columns>
        <asp:BoundField DataField="EmployeeID" Visible="true" />
...
<% For Each row As System.Data.DataRow In EngineerData.Rows%>
    <tr>
        <td>
