<%@ Page Language="C#" MasterPageFile="~/MyAdmin/_TemplateMasterNoSub.master" AutoEventWireup="true"
    CodeBehind="~/MyAdmin/Projects.apsx.cs" Inherits="KPFF.PMP.MyAdmin.Projects" Title="Untitled Page" %>
            ...
            <td>
                <table class="navTable">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnArchiveProjects" runat="server" CssClass="formButton" Text="Make Inactive" OnClick="btnArchiveProjects_Click" />
                        </td>
                        <td>
                            <asp:Button ID="btnActiveInactive" Text="View Inactive" CssClass="formButton" runat="server" OnClick="btnActiveInactive_Click" />
                        </td>
                        <td>
