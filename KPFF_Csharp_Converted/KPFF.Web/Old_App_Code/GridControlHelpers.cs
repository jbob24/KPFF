...
namespace KPFF.PMP
{
    public class GridControlHelpers
    {
        ...
        public static decimal GetFieldValue(DataRow row, string field)
        {
            try
            {
                var fieldValue = row[field].ToString();
                decimal fieldDecimal = 0;

                decimal.TryParse(fieldValue, out fieldDecimal);
        ...
        public static double GetFieldValueAsDouble(DataRow row, string field)
        {
            ...
            {
                var fieldValue = row[field].ToString();
                double fieldDecimal = 0;

                double.TryParse(fieldValue, out fieldDecimal);
